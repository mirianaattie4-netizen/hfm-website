          ...
          {digitalProducts.map((product) => (
            <div
              ...
              style={{
                ...
                cursor: "default",
                gridColumn: product.featured ? "span 1" : undefined,
              }}
              onMouseEnter={(e) => {
            ...
            >
              ...
              {!product.badge && <div style={{ height: "29px", marginBottom: "16px" }} />}
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px" }}>
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.background = product.featured
                      ? "#D4B87A"
                      : `${product.color}30`;
