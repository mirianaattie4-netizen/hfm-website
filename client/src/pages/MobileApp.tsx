...
import InscriptionTab from "./mobile/InscriptionTab";

type Tab = "home" | "histoire" | "galerie" | "programmes" | "inscription" | "entreprise" | "contact";
...
const tabs: { key: Tab; icon: string; label: string }[] = [
  ...
  { key: "inscription", icon: "📝", label: "S'inscrire" },
...
export default function MobileApp() {
  ...
  const renderTab = () => {
    switch (activeTab) {
      ...
      case "inscription": return <InscriptionTab />;
